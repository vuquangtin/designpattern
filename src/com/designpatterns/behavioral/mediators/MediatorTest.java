...
public class MediatorTest {
	...
	public static void main(String[] args) {
		...
		AirMediator m = new MediatorImpl();
...
class MediatorImpl implements AirMediator {
...
abstract class AbstractAirVehicle implements AirVehicle {
	...
	public AirMediator getMediator() {
		return mediator;
	}

	public void setMediator(AirMediator mediator) {
