...
public class CyclicBarrierDemo {
	...
	public static void main(String[] args) {
		...
		CyclicBarrierRunnable barrierRunnable1 = new CyclicBarrierRunnable(barrier1, barrier2, barrier3);

		CyclicBarrierRunnable barrierRunnable2 = new CyclicBarrierRunnable(barrier1, barrier2, barrier3);

		CyclicBarrierRunnable barrierRunnable3 = new CyclicBarrierRunnable(barrier1, barrier2, barrier3);
 ...
 * 循环屏障
 * 
 * @author zhaoming@yy.com 2014-4-6
 */
class CyclicBarrierRunnable implements Runnable {
	...
	public CyclicBarrierRunnable(CyclicBarrier barrier1, CyclicBarrier barrier2, CyclicBarrier barrier3) {
