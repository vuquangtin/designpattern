...
public class BankAccount {
	...
	public static class BankAccountBuilder {
		...
		public BankAccount build() {
			BankAccount bankAccount = new BankAccount(this.name,
					this.accountNumber, this.address, this.email,
		...
		private void validateUserObject(BankAccount bankAccount) {
			...
			if (this.newsletter && email == null) {
				throw new IllegalArgumentException(
						"Email can't be null when client want to receive the new letter");
			}
		}
	}
	...
	public String toString() {
		return "BankAccount [name=" + name + ", accountNumber=" + accountNumber
				+ ", address=" + address + ", email=" + email + ", newsletter="
				+ newsletter + ", mobileBanking=" + mobileBanking + "]";
	}
