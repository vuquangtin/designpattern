 ...
 * use of this code.
 * 
 * The bean information class for AddressDataEntryFormUI.
...
public class AddressDataEntryFormUIBeanInfo extends java.beans.SimpleBeanInfo {
	...
	public static java.lang.Class getBeanClass() {
		return AddressDataEntryFormUI.class;
	}
	...
	public java.beans.BeanDescriptor getBeanDescriptor() {
		...
		try {
			...
			aDescriptor = new java.beans.BeanDescriptor(AddressDataEntryFormUI.class);
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
	...
	/**
	 * Gets the setModel(AddressDataModel) method descriptor.
	 * @return java.beans.MethodDescriptor
	 */
	public java.beans.MethodDescriptor setModel_comjavadudearticlesvaddmvc1AddressDataModelMethodDescriptor() {
		java.beans.MethodDescriptor aDescriptor = null;
		try {
			/* Create and return the setModel(AddressDataModel) method descriptor. */
			java.lang.reflect.Method aMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aParameterTypes[] = {
			...
			/* aDescriptor.setDisplayName("setModel(AddressDataModel)"); */
			/* aDescriptor.setShortDescription("setModel(AddressDataModel)"); */
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
			/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
		} catch (java.lang.Throwable exception) {
