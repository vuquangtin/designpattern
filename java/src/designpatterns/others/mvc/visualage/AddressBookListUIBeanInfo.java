 ...
 * use of this code.
 *
 * The bean information class for AddressBookListUI.
...
public class AddressBookListUIBeanInfo extends java.beans.SimpleBeanInfo {
	 ...
	 */
	public static java.lang.reflect.Method findMethod(@SuppressWarnings("rawtypes") java.lang.Class aClass, java.lang.String methodName, int parameterCount) {
		try {
	...
	public static Class getBeanClass() {
		return AddressBookListUI.class;
	}
	...
	public java.beans.BeanDescriptor getBeanDescriptor() {
		...
		try {
			...
			aDescriptor = new java.beans.BeanDescriptor(AddressBookListUI.class);
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
	...
	/**
	 * Gets the loadList(AddressDataModel[], java.awt.List) method descriptor.
	 * @return java.beans.MethodDescriptor
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public java.beans.MethodDescriptor loadList_comjavadudearticlesvaddmvc1AddressDataModel___javaawtListMethodDescriptor() {
		java.beans.MethodDescriptor aDescriptor = null;
		try {
			/* Create and return the loadList(AddressDataModel[], java.awt.List) method descriptor. */
			java.lang.reflect.Method aMethod = null;
			try {
				/* Attempt to find the method using getMethod with parameter types. */
				java.lang.Class aParameterTypes[] = {
			...
			/* aDescriptor.setDisplayName("loadList(AddressDataModel[], java.awt.List)"); */
			/* aDescriptor.setShortDescription("loadList(AddressDataModel[], java.awt.List)"); */
			/* aDescriptor.setExpert(false); */
			/* aDescriptor.setHidden(false); */
			/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
		} catch (java.lang.Throwable exception) {
