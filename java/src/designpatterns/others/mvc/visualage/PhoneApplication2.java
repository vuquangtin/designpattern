...
public class PhoneApplication2 extends Frame implements Serializable {
...
class IvjEventHandler implements java.awt.event.WindowListener {
	 ...
	 */
	public PhoneApplication2(String title) {
		super(title);
	}
	...
	public static void main(java.lang.String[] args) {
		try {
			PhoneApplication2 aPhoneApplication2;
			aPhoneApplication2 = new PhoneApplication2();
			aPhoneApplication2.addWindowListener(new java.awt.event.WindowAdapter() {
				public void windowClosing(java.awt.event.WindowEvent e) {
					System.exit(0);
				};
			});
			aPhoneApplication2.setVisible(true);
	...
	private java.awt.Panel getContentsPane() {
		if (ivjContentsPane == null) {
			try {
				...
				getContentsPane().add(getlistUI(), getlistUI().getName());
	...
	/**
	 * Return the listUI property value.
	 * @return AddressBookListUI
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private AddressBookListUI getlistUI() {
		if (ivjlistUI == null) {
			try {
				ivjlistUI = new AddressBookListUI();
	...
	/**
	 * connPtoP4SetTarget:  (hashAddressBook.this <--> listUI.addressBookModel)
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	private void connPtoP4SetTarget() {
		/* Set the target from the source */
		try {
			getlistUI().setAddressBookModel(gethashAddressBook());
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {3}
