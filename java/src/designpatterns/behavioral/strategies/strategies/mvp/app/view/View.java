...
public class View extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup().addContainerGap()
						.addComponent(jInternalFrame1).addContainerGap()));
	...
	private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem1ActionPerformed
		// TODO add your handling code here:
		SoruBankasiView soruBankasiView = new SoruBankasiView();
		soruBankasiView.setPresenter(new SoruBankasiPresenter(soruBankasiView,
				new SoruBankasiModel(), new Model()));
	...
	private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem2ActionPerformed
		...
		SinavOlusturmaView sinavOlusturmaView = new SinavOlusturmaView();
		sinavOlusturmaView.setPresenter(new SinavOlusturmaPresenter(
				sinavOlusturmaView, new SinavOlusturmaModel(), new Model()));
