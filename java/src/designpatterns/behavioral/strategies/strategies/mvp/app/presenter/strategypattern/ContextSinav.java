...
public class ContextSinav {
	...
	public void executeStrategy3(String dersAdiSelectedItem,
		...
		sStrategy.SinavOlustur(dersAdiSelectedItem, kategoriSelectedItem,
				seviyeSelectedItem, derslikSelectedItem, gozetmenSelectedItem,
				sinavSoruTextBoxItem);
