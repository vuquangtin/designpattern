...
import observers.app.observerapp.ObserverController;
...
public class ObserverUI extends javax.swing.JFrame {
	...
	public void setModel(ArrayList<ObservableInterface> stocks,
			ArrayList<ChartController> charts) {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
			...
			Double price = Double.parseDouble(this.jTextField2.getText()
					.replaceAll(",", "."));
