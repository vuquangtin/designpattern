...
public class DlgModifyingHexagon extends JDialog {
	...
	protected int x, y, radius, moveByX, moveByY;
	...
	public Color hexagonBorderColor;
	public Color hexagonInnerColor;
	...
	public static void main(String[] args) {
		try {
			DlgModifyingHexagon dialog = new DlgModifyingHexagon();
	...
	public DlgModifyingHexagon() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel lblCenterX = new JLabel("Hexagon's center X coordinate:");
			...
			{
				JLabel lblCenterY = new JLabel("Hexagon's center Y coordinate:");
					...
					public void actionPerformed(ActionEvent arg0) {
						try{
							...
							if(borderColorChanged)
								hexagonBorderColor = borderColor;

							if(innerColorChanged)
								hexagonInnerColor = innerColor;
	...
	public Color getHexagonBorderColor() {
		return hexagonBorderColor;
	}

	public void setHexagonBorderColor(Color hexagonBorderColor) {
		this.hexagonBorderColor = hexagonBorderColor;
	}

	public Color getHexagonInnerColor() {
		return hexagonInnerColor;
	}

	public void setHexagonInnerColor(Color hexagonInnerColor) {
		this.hexagonInnerColor = hexagonInnerColor;
	}
