 ...
 * @author inanb
 */
public class CoktanSecmeliOrtaSoru implements SoruBankasiStrategy{
    ...
    {
        String path2 = Main.PATH_CONTENT + "SoruBankasi/TasarimDesenleriÇoktanSeçmeliOrta.txt";
        
       
        
        if(zorlukDereceseiSelectedItem.equals("Orta")&&soruTipiSelectedItem.equals("Çoktan Seçmeli"))  {      
            try{
